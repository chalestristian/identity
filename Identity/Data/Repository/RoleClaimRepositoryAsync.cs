...
public class RoleClaimRepositoryAsync : RepositoryBaseAsync<RoleClaim>, IRoleClaimRepositoryAsync
{    
    public RoleClaimRepositoryAsync(IdentityDbContext context) : base(context){}
}